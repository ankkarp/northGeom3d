...
В настройках преокта указаны две камеры с их начальными позициями, количество ракурсов с которых необходимо произвести рендеринг. Так же в проекты добавлены различные структуры фигур и их исвойтва, положение освещения.
